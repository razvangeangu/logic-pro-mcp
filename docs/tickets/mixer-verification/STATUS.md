...
**Size**: XL · **Current Phase**: 9 (v3.4.5 release)
...
| C1 | version finalize 3.4.5 (7면) | T1 | **In release** | green | ServerConfig/manifest/Formula version/install.sh/README/CHANGELOG/ResourceProvider/test banners synced to 3.4.5. Formula sha256 is filled after published artifact. |
...
- **Release boundary**: v3.4.5 stable release is the active ship target. Published SHA256/Formula lockstep is verified after GitHub Actions publishes the release artifact.
